...
Следует иметь ввиду что полная версия компилятора сейчас пока только на языке Go.  Это go.gad версия 2.06 - поддерживает ключи -go -rust -mojo -python -asm -asm32 
